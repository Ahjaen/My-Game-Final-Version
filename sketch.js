...
function setup(){
    ...
    w34 = createSprite(125, 3, 50, 5)
    w34.visible = false
    w35 = createSprite(475, 3, 50, 5)
    w35.visible = false
    w36 = createSprite(598, 450, 5, 100)
    ...
    cop1.setCollider("rectangle", 20, 0, 70, cop1.height)
    cop2.setCollider("rectangle", 20, 0, 70, cop1.height)
